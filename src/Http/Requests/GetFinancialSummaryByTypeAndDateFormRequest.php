...
class GetFinancialSummaryByTypeAndDateFormRequest extends FormRequest
{    
    /**
    ...
    public function rules() 
    {
        return [
            'holder_id'   => 'required',
            'holder'      => [ 'required', new CheckHolder($this->holder) ],
    ...
    {
        return [
            'holder_id'   => trans('finance.holder_id_is_required'),
            'holder'      => trans('finance.holder_is_required'),
    ...
    protected function prepareForValidation()
    {
        ...
        switch ($this->holder_type) {
            case Finance::TYPE_USER:
                $this->holder = User::find($this->holder_id);
                break;
            case Finance::TYPE_PROVIDER:
                $this->holder = Provider::find($this->holder_id);
                break;
